...
(function (factory) {
  ...
  var toHtmlElem$2 = function toHtmlElem(parent, selector) {
    return selector ? parent.querySelector(selector) : null;
  };
  var getAnchors$1 = function getAnchors(selector, d) {
    var matches = (d || window.document).querySelectorAll(selector);
    var anchors = toArray$1(matches).filter(function (e) {
      return !loaded$1(e);
    });
    if (anchors.length === 0) return [];
    anchors.forEach(function (anchor) {
      return markLoaded$1(anchor);
    });
    return anchors;
  };
  ...
  var hide$2 = function hide(e) {
    e.style.display = "none";
    return e;
  };
  var show$2 = function show(e) {
    e.style.display = "";
    return e;
  };
  ...
  var getTargets = function getTargets(parent, selectors) {
    var line_1 = toHtmlElem$2(parent, selectors.line_1);
    if (line_1 === null) return null;
    var post_town = toHtmlElem$2(parent, selectors.post_town);
    if (post_town === null) return null;
    var postcode = parent.querySelector(selectors.postcode);
    if (postcode === null) return null;
    var line_2 = toHtmlElem$2(parent, selectors.line_2);
    var line_3 = toHtmlElem$2(parent, selectors.line_3);
    var country = toHtmlElem$2(parent, selectors.country);
    var county = toHtmlElem$2(parent, selectors.county);
    var organisation = toHtmlElem$2(parent, selectors.organisation);
    return {
      line_1: line_1,
      line_2: line_2,
      line_3: line_3,
  ...
  var relevantPage = function relevantPage(bindings) {
  ...
  var config = function config() {
    ...
    return _objectSpread$d(_objectSpread$d({}, defaults$6), c);
  };
  var generateTimer$1 = function generateTimer(_ref) {
  ...
  var setup$2 = function setup(_ref2) {
    var bindings = _ref2.bindings,
        _ref2$callback = _ref2.callback,
        callback = _ref2$callback === void 0 ? NOOP$2 : _ref2$callback;
    var c = config();
    if (c === undefined) return callback();
    if (!relevantPage(bindings)) return callback();
    var result = bindings.reduce(function (prev, binding) {
      var pageTest = binding.pageTest,
          bind = binding.bind;
      if (!pageTest()) return prev;

      var _generateTimer = generateTimer$1({
        pageTest: pageTest,
        bind: bind
      }),
  ...
  var DEFAULT_SCOPE = "form";
  var DEFAULT_ANCHOR = "line_1";
  var setupBind = function setupBind(_ref3) {
    var selectors = _ref3.selectors,
        anchorSelector = _ref3.anchorSelector,
        parentScope = _ref3.parentScope,
        doc = _ref3.doc,
        parentTest = _ref3.parentTest;
    var anchors = getAnchors$1(anchorSelector || selectors[DEFAULT_ANCHOR], doc);
    return anchors.reduce(function (prev, anchor) {
      var parent = getParent$1(anchor, parentScope || DEFAULT_SCOPE, parentTest);
      if (!parent) return prev;
      var targets = getTargets(parent, selectors);
  ...
  var newEvent$2 = function newEvent(_ref) {
  ...
  var trigger$2 = function trigger(e, event) {
    return e.dispatchEvent(newEvent$2({
      event: event
    }));
  };

  var isSelect$2 = function isSelect(e) {
  ...
  var update$3 = function update(input, value) {
    var skipTrigger = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    if (!input) return;
    if (!isInput$2(input) && !isTextarea$1(input)) return;
    change$2({
      e: input,
      value: value,
  ...
  var updateSelect$2 = function updateSelect(_ref) {
    var e = _ref.e,
        value = _ref.value,
        skipTrigger = _ref.skipTrigger;
    if (value === null) return;
    if (!isSelect$2(e)) return;
    setValue$2(e, value);
    if (!skipTrigger) trigger$2(e, "select");
    trigger$2(e, "change");
  };

  var setValue$2 = function setValue(e, value) {
  ...
  var updateInput$2 = function updateInput(_ref2) {
    var e = _ref2.e,
        value = _ref2.value,
        skipTrigger = _ref2.skipTrigger;
    if (value === null) return;
    if (!isInput$2(e) && !isTextarea$1(e)) return;
    setValue$2(e, value);
    if (!skipTrigger) trigger$2(e, "input");
    trigger$2(e, "change");
  };

  var change$2 = function change(options) {
    if (options.value === null) return;
    updateSelect$2(options);
    updateInput$2(options);
  };

  var toCiIso$2 = function toCiIso(address) {
    if (/^GY/.test(address.postcode)) return "GG";
    if (/^JE/.test(address.postcode)) return "JE";
    return null;
  };
  var IOM$2 = "Isle of Man";
  var EN$2 = "England";
  var SC$2 = "Scotland";
  var WA$2 = "Wales";
  var NI$2 = "Northern Ireland";
  var CI$2 = "Channel Islands";
  var toIso$2 = function toIso(address) {
    var country = address.country;
    if (country === EN$2) return "GB";
    if (country === SC$2) return "GB";
    if (country === WA$2) return "GB";
    if (country === NI$2) return "GB";
    if (country === IOM$2) return "IM";
    if (country === CI$2) return toCiIso$2(address);
    return null;
  };
  ...
  var idpcState$1 = function idpcState() {
    return g$2;
  };

  var idGen$1 = function idGen() {
    ...
    try {
      ...
      if (newValue && (_typeof(newValue) === 'object' || typeof newValue === 'function')) {
        ...
        if (newValue instanceof Promise$1) {
          ...
          doResolve(bind$h(then, newValue), self);
          return;
        }
      }
  ...
  var Client$3 = /*#__PURE__*/function () {
    function Client(config) {
      ...
      this.config = _objectSpread$c(_objectSpread$c({}, defaults$5), config);
      this.config.header = _objectSpread$c(_objectSpread$c({}, defaults$5.header), config.header && config.header);
    }
    /**
  ...
  var isArray$4 = function isArray(i) {
  ...
  var toHeader$3 = function toHeader(_ref2, client) {
    ...
    return _objectSpread$b(_objectSpread$b({}, client.config.header), toStringMap$1(header));
  };
  /**
   * toAuthHeader
   *
  ...
  var toAuthHeader$1 = function toAuthHeader(client, options) {
    var credentials = [];
    ...
    return "IDEALPOSTCODES ".concat(toCredentialString$1(credentials));
  };
  /**
   * appendAuthorization
   *
  ...
  var appendAuthorization$1 = function appendAuthorization(_ref3) {
    var header = _ref3.header,
        options = _ref3.options,
        client = _ref3.client;
    header.Authorization = toAuthHeader$1(client, options);
    return header;
  };

  var toCredentialString$1 = function toCredentialString(credentials) {
  ...
  var appendIp$1 = function appendIp(_ref6) {
  ...
  var appendFilter$1 = function appendFilter(_ref7) {
  ...
  var appendTags$1 = function appendTags(_ref8) {
  ...
  var isObject$e = function isObject(o) {
  ...
  var isErrorResponse$1 = function isErrorResponse(body) {
    if (!isObject$e(body)) return false;
  ...
  var resource$9 = "autocomplete/addresses";
  ...
  var lookupUdprn = function lookupUdprn(options) {
    ...
    return retrieve$1(options.client, options.udprn.toString(), queryOptions).then(function (response) {
      ...
      if (error instanceof IdpcUdprnNotFoundError$1) return null;
      throw error;
    });
  };
  /**
  ...
  var lookupUmprn = function lookupUmprn(options) {
    ...
    return retrieve(options.client, options.umprn.toString(), queryOptions).then(function (response) {
      ...
      if (error instanceof IdpcUmprnNotFoundError$1) return null;
      throw error;
    });
  };
  /**
  ...
  var bind$g = function bind(fn, thisArg) {
  ...
  function isStream(val) {
    return isObject$d(val) && isFunction(val.pipe);
  }
  /**
  ...
  utils$4.forEach(['post', 'put', 'patch'], function forEachMethodWithData(method) {
    defaults$4.headers[method] = utils$4.merge(DEFAULT_CONTENT_TYPE);
  });
  ...
  function createInstance(defaultConfig) {
    ...
    var instance = bind$e(Axios.prototype.request, context); // Copy axios.prototype to instance
  ...
  var Client$2 = /*#__PURE__*/function (_CoreInterface) {
    ...
    function Client(config) {
      ...
      return _super.call(this, _objectSpread$a({
        agent: agent
      }, config));
    }
  ...
  var getScope$1 = function getScope(scope) {
    if (isString$2(scope)) return d$2().querySelector(scope);
  ...
  var update$2 = function update(input, value) {
    var skipTrigger = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    if (!input) return;
    if (!isInput$1(input) && !isTextarea(input)) return;
    change$1({
      e: input,
      value: value,
      skipTrigger: skipTrigger
  ...
  var updateInput$1 = function updateInput(_ref2) {
    var e = _ref2.e,
        ...
        skipTrigger = _ref2.skipTrigger;
    if (value === null) return;
    if (!isInput$1(e) && !isTextarea(e)) return;
    setValue$1(e, value);
  ...
  var ordinaryToPrimitive$1 = function ordinaryToPrimitive(input, pref) {
    var fn, val;
    if (pref === 'string' && isCallable$b(fn = input.toString) && !isObject$b(val = fn.call(input))) return val;
    if (isCallable$b(fn = input.valueOf) && !isObject$b(val = fn.call(input))) return val;
    if (pref !== 'string' && isCallable$b(fn = input.toString) && !isObject$b(val = fn.call(input))) return val;
  ...
  var isObject$8 = isObject$c; // `Assert: Type(argument) is Object`
  ...
  */
  ...
  var _export = function _export(options, source) {
    ...
    for (key in source) {
      ...
      if (options.bind && USE_NATIVE) resultProperty = bind$d(sourceProperty, global$5); // wrap global constructors for prevent changs in this version
      else if (options.wrap && USE_NATIVE) resultProperty = wrapConstructor(sourceProperty); // make static versions for prototype methods
      else if (PROTO && isCallable$9(sourceProperty)) resultProperty = bind$d(Function.call, sourceProperty); // default case
  ...
  var arraySpeciesConstructor$1 = function arraySpeciesConstructor(originalArray) {
    ...
    if (isArray$1(originalArray)) {
      ...
      if (isConstructor$1(C) && (C === Array || isArray$1(C.prototype))) C = undefined;else if (isObject$5(C)) {
        C = C[SPECIES$2];
  ...
  ***************************************************************************** */
    ...
    var machine = s({
      ...
      states: {
        ...
        notifying: {
          ...
          on: _objectSpread$8(_objectSpread$8(_objectSpread$8(_objectSpread$8({}, CLOSE), SUGGEST), NOTIFY), INPUT)
        },
        suggesting: {
          entry: ["renderSuggestions", "gotoCurrent", "expand"],
          exit: ["resetCurrent", "gotoCurrent", "contract"],
          on: _objectSpread$8(_objectSpread$8(_objectSpread$8(_objectSpread$8(_objectSpread$8({}, CLOSE), SUGGEST), NOTIFY), INPUT), {}, {
            NEXT: {
    ...
    _createClass(View, [{
      ...
      value: function hiddenFields() {
        ...
        return this.options.hide.map(function (e) {
          if (isString$2(e)) return toHtmlElem$1(_this2.options.scope, e);
          return e;
        }).filter(function (e) {
          return e !== null;
        });
  ...
  var Controller$1 = /*#__PURE__*/function () {
    function Controller(options) {
      ...
      this.view = new View(_objectSpread$7(_objectSpread$7({}, this.options), {}, {
        scope: this.scope,
  ...
  var errors = /*#__PURE__*/Object.freeze({
    __proto__: null,
    IdealPostcodesError: IdealPostcodesError$1,
    IdpcApiError: IdpcApiError,
    IdpcBadRequestError: IdpcBadRequestError,
    IdpcUnauthorisedError: IdpcUnauthorisedError,
    IdpcInvalidKeyError: IdpcInvalidKeyError,
    IdpcRequestFailedError: IdpcRequestFailedError,
    IdpcBalanceDepletedError: IdpcBalanceDepletedError,
    IdpcLimitReachedError: IdpcLimitReachedError,
    IdpcResourceNotFoundError: IdpcResourceNotFoundError,
    IdpcPostcodeNotFoundError: IdpcPostcodeNotFoundError,
    IdpcKeyNotFoundError: IdpcKeyNotFoundError,
    IdpcUdprnNotFoundError: IdpcUdprnNotFoundError,
    IdpcUmprnNotFoundError: IdpcUmprnNotFoundError,
    IdpcServerError: IdpcServerError,
    parse: parse
  });
  ...
  var toHeader$1 = function toHeader(_ref2, client) {
    var _ref2$header = _ref2.header,
        header = _ref2$header === void 0 ? {} : _ref2$header;
    return _objectSpread$5(_objectSpread$5({}, client.header), toStringMap(header));
  };
  /**
   * toAuthHeader
   *
  ...
  var create$5 = function create(client) {
    var list = listMethod({
      resource: resource$5,
      client: client
    });
  ...
  var resource$4 = "postcodes";
  var create$4 = function create(client) {
  ...
  var resource$3 = "keys";
  var create$3 = function create(client) {
    var retrieve = retrieveMethod({
      resource: resource$3,
      client: client
    });
  ...
  var create$2 = function create(client) {
    var retrieve = retrieveMethod({
      resource: resource$2,
      client: client
    });
  ...
  var create$1 = function create(client) {
    var retrieve = retrieveMethod({
      resource: resource$1,
      client: client
    });
  ...
  var create = function create(client) {
    var list = listMethod({
      resource: resource,
      client: client
    });
  ...
  var Client$1 = /*#__PURE__*/function () {
    function Client(config) {
      ...
      this.header = _objectSpread$4(_objectSpread$4({}, Client.defaults.header), config.header);
      this.postcodes = create$4(this);
      this.addresses = create$5(this);
      this.udprn = create$2(this);
      this.umprn = create$1(this);
      this.keys = create$3(this);
      this.autocomplete = create(this);
    }
    /**
     * Return base URL for API requests
     */
    ...
    _createClass(Client, [{
      key: "url",
      value: function url() {
        return "".concat(this.protocol(), "://").concat(this.baseUrl, "/").concat(this.version);
      }
    }, {
      key: "protocol",
      value: function protocol() {
      ...
      value: function ping() {
        var method = "GET";
        var url = "".concat(this.protocol(), "://").concat(this.baseUrl, "/");
      ...
      key: "lookupPostcode",
      value: function lookupPostcode(options) {
      ...
      key: "lookupAddress",
      value: function lookupAddress(options) {
        var header = {};
        var query = {
          query: options.query
        };
      ...
      key: "toAddressIdQuery",
      value: function toAddressIdQuery(options) {
        var header = {};
        var query = {};
        appendAuthorization({
          client: this,
      ...
      key: "lookupUdprn",
      value: function lookupUdprn(options) {
        var queryOptions = this.toAddressIdQuery(options);
      ...
      key: "lookupUmprn",
      value: function lookupUmprn(options) {
        var queryOptions = this.toAddressIdQuery(options);
      ...
      key: "checkKeyUsability",
      value: function checkKeyUsability(options) {
        var _options$api_key = options.api_key,
            api_key = _options$api_key === void 0 ? this.api_key : _options$api_key,
            timeout = options.timeout;
        var licensee = options.licensee;
        var query;
   ...
   */
  var API_URL = "api.ideal-postcodes.co.uk";
  /**
  ...
  var STRICT_AUTHORISATION = false;
  ...
  var Client = /*#__PURE__*/function (_CoreInterface) {
    ...
    function Client(config) {
      ...
      var agent = new Agent();
      var header = {};
      var tls = config.tls === undefined ? TLS : config.tls;
      var baseUrl = config.baseUrl === undefined ? API_URL : config.baseUrl;
      var version = config.version === undefined ? VERSION : config.version;
      var strictAuthorisation = config.strictAuthorisation === undefined ? STRICT_AUTHORISATION : config.strictAuthorisation;
      var timeout = config.timeout === undefined ? TIMEOUT : config.timeout;
      ...
      var interfaceConfig = {
        ...
        baseUrl: baseUrl,
        version: version,
        strictAuthorisation: strictAuthorisation,
        timeout: timeout,
        tags: tags,
        header: _objectSpread$3(_objectSpread$3({}, header), config.header)
      };
  ...
  var populateAddress = function populateAddress(options) {
    var outputFields = options.outputFields,
        config = options.config;

    var address = _objectSpread$2({}, options.address);
    ...
    for (e in outputFields) {
      if (notInAddress(address, e)) continue;

      if (outputFields.hasOwnProperty(e)) {
        var value = outputFields[e];
        if (!value) continue;
  ...
  var Controller = /*#__PURE__*/function () {
    ...
    _createClass(Controller, [{
      ...
      value: function searchPostcode(postcode) {
        return this.client.lookupPostcode({
          postcode: postcode
        });
      }
      /**
      ...
      value: function searchAddress(query) {
        return this.client.lookupAddress({
          query: query,
      ...
      value: function init() {
        ...
        this.client.checkKeyUsability({}).then(function (_ref) {
          var available = _ref.available;
          if (!available) return Promise$1.reject("Key not available");
          return initPlugin();
        }).catch(function (error) {
      ...
      value: function populateAddress$1(address) {
        ...
        var config = _objectSpread$1(_objectSpread$1({}, this.options), {}, {
          scope: this.outputScope
        });
  ...
  var isSupported = function isSupported(c) {
    return ["GB", "IM", "JE", "GG"].indexOf(c || "") !== -1;
  };

  var newSpan = function newSpan(innerElem) {
  ...
  var parseSelector = function parseSelector(subSelector) {
    var obj = {
      tag: null,
      classes: [],
      id: null,
  ...
  var insertPostcodeField = function insertPostcodeField(targets) {
    var entity = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "p";
    var contextClass = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    if (targets.line_1 === null) return null;
    var selector = parseSelector(entity);
    var tag = selector.tag !== null ? selector.tag : entity;
    var wrapperClass = contextClass !== null ? contextClass : "form-row";
    var target = getParent$1(targets.line_1, tag, function (element) {
      var check = true;

      if (selector.classes.length > 0) {
        check = selector.classes.every(function (cls) {
    ...
    wrapper.className = "".concat(wrapperClass, " idpc_lookup field");
    insertBefore({
      target: target,
      elem: wrapper
    });
    ...
    input.setAttribute("aria-label", "Search a postcode to retrieve your address");
    input.id = "idpc_input";
    ...
    var selectContainer = document.createElement("span");
  ...
  var insertAddressFinder = function insertAddressFinder(targets) {
    if (targets.line_1 === null) return null;
    var id = idGen$1()();
    var target = getParent$1(targets.line_1, "p");
    if (target === null) return null;
  ...
  var toOutputFields = function toOutputFields(config, selectors) {
    var outputFields = _objectSpread({}, selectors);

    if (config.populateOrganisation === false) delete outputFields.organisation_name;
    if (config.populateCounty === false) delete outputFields.county;
    return outputFields;
  };
  var legacyPostcodeConfig = {
    inputId: "idpc_input",
  ...
  var updateCheckout = function updateCheckout() {
    return window.jQuery(document.body).trigger("update_checkout");
  };

  var newBind = function newBind(selectors) {
    return function (config) {
      if (config.enabled !== true) return;
      var pageBindings = setupBind({
        selectors: selectors
      });
      var outputFields = toOutputFields(config, selectors);
      pageBindings.forEach(function (binding) {
        ...
        var localConfig = {
          ...
          tags: tags,
          outputFields: outputFields,
          onAddressPopulated: function onAddressPopulated(address) {
            if (isString$5(outputFields.country)) {
              var countryField = toHtmlElem$2(parent, outputFields.country);

              if (isInput$2(countryField)) {
                var iso = toIso$2(address);
                if (iso) update$3(countryField, iso);
              }
            }
        ...
        if (config.postcodeLookup) {
          var result = insertPostcodeField(targets, config.entity, config.contextClass || null);

          if (result) {
            var context = result.context,
                button = result.button,
                input = result.input,
                selectContainer = result.selectContainer,
                wrapper = result.wrapper;
            plContainer = wrapper;
            PostcodeLookup.setup(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, legacyPostcodeConfig), config), localConfig), {}, {
              context: context,
              input: input,
              button: button,
              selectContainer: selectContainer
        ...
        if (config.autocomplete) {
          ...
          af = AddressFinder.setup(_objectSpread(_objectSpread(_objectSpread({
            injectStyle: false
          }, config), {}, {
            autocomplete: AddressFinder.defaults.autocomplete
          }, localConfig), {}, {
            inputField: f ? f.input : selectors.line_1
          }, config.autocompleteOverride));
        }

        var country = targets.country || null;

        var checkCountry = function checkCountry() {
          if (isSupported(country.value)) {
            if (plContainer) show$2(plContainer);
            if (f) show$2(f.elem);
            if (af) af.view.attach();
          } else {
            if (plContainer) hide$2(plContainer);
            if (f) hide$2(f.elem);
        ...
        if (config.watchCountry && country) {
          window.jQuery(country).change(checkCountry);
          checkCountry();
        }
      });
    };
  ...
  var pageTest$3 = function pageTest() {
    return document.querySelector(".woocommerce-checkout") !== null;
  };
  var selectors$3 = {
  ...
  var bind$3 = newBind(selectors$3); //@ts-ignore
  ...
  var bind$2 = newBind(selectors$2); //@ts-ignore
  ...
  var shipping = /*#__PURE__*/Object.freeze({
    __proto__: null,
    pageTest: pageTest$2,
  ...
  var pageTest$1 = function pageTest() {
    return document.querySelector(".woocommerce-address-fields") !== null;
  };
  var selectors$1 = {
    line_1: "#shipping_address_1",
    line_2: "#shipping_address_2",
  ...
  var bind$1 = newBind(selectors$1); //@ts-ignore
  ...
  var accountShipping = /*#__PURE__*/Object.freeze({
    __proto__: null,
    pageTest: pageTest$1,
  ...
  var bind = newBind(selectors); //@ts-ignore
  ...
  var accountBilling = /*#__PURE__*/Object.freeze({
    __proto__: null,
    pageTest: pageTest,
    selectors: selectors,
    bind: bind,
